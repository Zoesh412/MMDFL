...
def get_dataset(args):
    ...
    if args.dataset == 'mnist':
        ...
        if args.cifar100_coarse == 0:
            ...
            dataset_train = mydata.CIFAR100_coarse('./data/cifar100', train=True, download=True, transform=trans_cifar100_train)
            dataset_test = mydata.CIFAR100_coarse('./data/cifar100', train=False, download=True, transform=trans_cifar100_val)
        if args.generate_data:
            if args.iid:
                dict_users = cifar_iid(dataset_train, args.num_users)
            elif args.noniid_case < 4:
